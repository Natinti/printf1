...
int write_num(int ind, char buffer[], int flags, int width, int precision, int length, cha padd, char extra_c);
...
lnong int convert_size_unsigned(unsigned long int num, int size);
